...
export const setInstagramItems = (instagramItems) => ({
  type: SET_INSTAGRAM_ITEMS,
  instagramItems,
});
export const getCurrentPhoto = (currentPhoto) => ({ type: GET_CURRENT_PHOTO, currentPhoto });
export const isButtonActiveState = (isButtonActive) => ({
  type: IS_BUTTON_ACTIVE_STATUS,
  isButtonActive,
});
export const isLoadMoreDisabledState = (isLoadMoreDisabled) => ({
  type: IS_LOAD_MORE_DISABLED,
  isLoadMoreDisabled,
});
