        ...
        <GoogleMap
          ...
          <div>
            ...
            <div className="geography__content">
              <button className={`btn ${entity && 'active'}`} onClick={handleEntity}>
                юрлица
              </button>
              <button className={`btn ${person && 'active'}`} onClick={handlePerson}>
                физлица
              </button>
              <button className={`btn ${all && 'active'}`} onClick={handleAll}>
                показать всё
              </button>
            </div>
          </div>
